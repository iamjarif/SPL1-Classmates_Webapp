            ...
            <div class="app-card-header px-4 py-3">
              <div class="row g-4 mb-4">
                <div class="col-12 col-lg-3">
                  <img
                    class="image"
                    src="assets/images/Notice/notice_sample.png"
                    alt="HTML5 Icon"
                ...
                <div class="col-12 col-lg-7">
                  <div class="row g-3 align-items-center mt-6">
                    <div class="col-12 col-lg-auto text-center text-lg-start">
                      <h4 class="notification-title mb-1">Class cancelled</h4>
                    ...
                    <div class="notification-content">
                      ...
                      Finibus Bonorum et Malorum" by Cicero are also reproduced
                      in their exact original form, accompanied by English
